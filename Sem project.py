...
hero_d20= random.randint(1,20) + (partyDict["Astarion"]["Init"])
print(hero_d20)

villain_d20= random.randint(1,20) + (enemyDict["Mindflayer"]["Init"])
print(villain_d20)


if hero_d20 > villain_d20:
    print("hero goes first")
elif hero_d20 < villain_d20:
...
hero_attack_roll=random.randint(1,20)+(partyDict["Astarion"]["AtkMod"])
print(hero_attack_roll)

villian_attack_roll=random.randint(1,20)+(enemyDict["Mindflayer"]["AtkMod"])
print(villian_attack_roll)
